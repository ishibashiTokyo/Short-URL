...
class MakeURL
{
	...
	private function baseStrings() {
		...
		if ( $this->useAlphanumeric ) $this->base_strings .= self::ALPHANUMERIC;
		if ( $this->useUpperLetter ) $this->base_strings .= self::UPPER_LETTER;
		if ( $this->useLowerLetter ) $this->base_strings .= self::LOWER_LETTER;
